...
import com.example.ajoe.agro.AlarmReceiver;
import com.example.ajoe.agro.Constants;
import com.example.ajoe.agro.R;
import com.example.ajoe.agro.adapters.ViewPagerAdapter;
import com.example.ajoe.agro.adapters.WeatherRecyclerAdapter;
import com.example.ajoe.agro.fragments.RecyclerViewFragment;
import com.example.ajoe.agro.models.Weather;
import com.example.ajoe.agro.tasks.GenericRequestTask;
import com.example.ajoe.agro.tasks.ParseResult;
import com.example.ajoe.agro.tasks.TaskOutput;
import com.example.ajoe.agro.utils.UnitConvertor;
import com.example.ajoe.agro.widgets.AbstractWidgetProvider;
import com.example.ajoe.agro.widgets.DashClockWeatherExtension;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void aboutDialog() {
        ...
        String about = "<p>1.6.1</p>" +
                ...
                "<p>Developed by <a href='https://ajoe.000webhostapp.com/'>Ajoe Thambi</a></p>" +
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.send){
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT,"Weather details");

...
public class SignUp extends AppCompatActivity {
    ...
    private EditText username, email, password,phone,place;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                signup(uName, mail, pass,phn,pla);
            }
        });
    }

    private void signup(final String username, final String email, final String password,final String phone,final String place){
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        startActivity(new Intent(SignUp.this, nav.class));
                    } else {
